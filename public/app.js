document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('process').addEventListener('click', function () {
        ...
        fetch('/api/process', { method: 'POST', body: body, credentials: 'same-origin' })
    ...
    document.getElementById('delete').addEventListener('click', function () {
        ...
        fetch('/api/delete', { method: 'POST', body: body, credentials: 'same-origin' })
            .then(function (response) {
                if (!response.ok) throw new Error('HTTP ' + response.status);
                return response.text();
            })
    ...
    function loadImageList(ext, targetId) {
        fetch('/api/images?ext=' + encodeURIComponent(ext))
